...
class UserSyncServiceTest {
    ...
    void testApplyStateDifferenceToIpa() throws FreeIpaClientException {
        ...
        doNothing().when(freeIpaClient).callBatch(any(), any(), any());
        doNothing().when(freeIpaClient).callBatch(any(), any(), any(), any());
        ...
        verify(freeIpaClient, times(4)).callBatch(any(), any(), any());
        verify(freeIpaClient, times(2)).callBatch(any(), any(), any(), any());
