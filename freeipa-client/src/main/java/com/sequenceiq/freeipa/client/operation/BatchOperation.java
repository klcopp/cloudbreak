...
import static com.sequenceiq.freeipa.client.FreeIpaClient.METHOD_NAME_BATCH;
...
public class BatchOperation extends AbstractFreeipaOperation<Object> {
    ...
    public static BatchOperation get(List<Object> operations, BiConsumer<String, String> warnings, Set<FreeIpaErrorCodes> acceptableErrorCodes) {
        return new BatchOperation(operations, warnings, acceptableErrorCodes);
    }

    @Override
    public String getMethodName() {
        return METHOD_NAME_BATCH;
    }
