...
public class BatchOperationTest {
    ...
    public void testInvokeWhenOperationsEmpty() throws FreeIpaClientException {
        ...
        BatchOperation.get(Lists.newArrayList(), warnings::put, Set.of()).invoke(freeIpaClient);
    ...
    public void testInvoke() throws FreeIpaClientException {
        ...
        UserAddOperation.get("user", "first", "last").appendOperationToBatchCall(operations);
        BatchOperation.get(operations, warnings::put, Set.of()).invoke(freeIpaClient);
    ...
    public void testInvokeIfAcceptableErrorOccurs() throws FreeIpaClientException {
        ...
        UserAddOperation.get("user", "first", "last").appendOperationToBatchCall(operations);
        BatchOperation.get(operations, warnings::put, Set.of(FreeIpaErrorCodes.DUPLICATE_ENTRY)).invoke(freeIpaClient);
    ...
    public void testInvokeIfOtherErrorOccurs() throws FreeIpaClientException {
        ...
        UserAddOperation.get("user", "first", "last").appendOperationToBatchCall(operations);
        BatchOperation.get(operations, warnings::put, Set.of(FreeIpaErrorCodes.NOT_FOUND)).invoke(freeIpaClient);
