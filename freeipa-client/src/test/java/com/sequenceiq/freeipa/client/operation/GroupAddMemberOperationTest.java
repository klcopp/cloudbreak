...
public class GroupAddMemberOperationTest {
    ...
    public void testInvokeWhenGroupNotManaged() {
        ...
        assertThrows(FreeIpaClientException.class, () ->
                GroupAddMemberOperation.get("editors", USERS, warnings::put).invoke(freeIpaClient));
    ...
    public void testInvoke() throws FreeIpaClientException {
        ...
        GroupAddMemberOperation.get(GROUP_NAME, USERS, warnings::put).invoke(freeIpaClient);
